...
function nt(t2, e2) {
  return __async(this, null, function* () {
    var n2;
    void 0 === e2 && (e2 = {});
    const { x: o2, y: i2, platform: s2, rects: r2, elements: l2, strategy: c2 } = t2, { boundary: a2 = "clippingAncestors", rootBoundary: u2 = "viewport", elementContext: h2 = "floating", altBoundary: d2 = false, padding: f2 = 0 } = D(e2, t2), p2 = K(f2), g2 = l2[d2 ? "floating" === h2 ? "reference" : "floating" : h2], m2 = G(yield s2.getClippingRect({ element: null == (n2 = yield null == s2.isElement ? void 0 : s2.isElement(g2)) || n2 ? g2 : g2.contextElement || (yield null == s2.getDocumentElement ? void 0 : s2.getDocumentElement(l2.floating)), boundary: a2, rootBoundary: u2, strategy: c2 })), v2 = "floating" === h2 ? { x: o2, y: i2, width: r2.floating.width, height: r2.floating.height } : r2.reference, y2 = yield null == s2.getOffsetParent ? void 0 : s2.getOffsetParent(l2.floating), x2 = (yield null == s2.isElement ? void 0 : s2.isElement(y2)) && (yield null == s2.getScale ? void 0 : s2.getScale(y2)) || { x: 1, y: 1 }, b2 = G(s2.convertOffsetParentRelativeRectToViewportRelativeRect ? yield s2.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: l2, rect: v2, offsetParent: y2, strategy: c2 }) : v2);
...
}, getOffsetParent: Ut, getElementRects: function(t2) {
  return __async(this, null, function* () {
    const e2 = this.getOffsetParent || Ut, n2 = this.getDimensions, o2 = yield n2(t2.floating);
    return { reference: Nt(t2.reference, yield e2(t2.floating), t2.strategy), floating: { x: 0, y: 0, width: o2.width, height: o2.height } };
  });
...
var Zt = function(t2) {
  return void 0 === t2 && (t2 = {}), { name: "autoPlacement", options: t2, fn(e2) {
    return __async(this, null, function* () {
      var n2, o2, i2;
      ...
      })(f2 || null, g2, p2) : p2, y2 = yield a2.detectOverflow(e2, m2), x2 = (null == (n2 = l2.autoPlacement) ? void 0 : n2.index) || 0, b2 = v2[x2];
      if (null == b2) return {};
      const w2 = N(b2, s2, yield null == a2.isRTL ? void 0 : a2.isRTL(u2.floating));
...
var Kt = function(t2) {
  return void 0 === t2 && (t2 = {}), { name: "shift", options: t2, fn(e2) {
    return __async(this, null, function* () {
      const { x: n2, y: o2, placement: i2, platform: l2 } = e2, c2 = D(t2, e2), { mainAxis: a2 = true, crossAxis: u2 = false, limiter: h2 = { fn: (t3) => {
        let { x: e3, y: n3 } = t3;
        return { x: e3, y: n3 };
      } } } = c2, d2 = r(c2, tt), f2 = { x: n2, y: o2 }, p2 = yield l2.detectOverflow(e2, d2), g2 = B($(i2)), m2 = I(g2);
...
var Gt = function(t2) {
  return void 0 === t2 && (t2 = {}), { name: "flip", options: t2, fn(e2) {
    return __async(this, null, function* () {
      var n2, o2;
      ...
      const x2 = $(i2), b2 = B(c2), w2 = $(c2) === c2, E2 = yield null == a2.isRTL ? void 0 : a2.isRTL(u2.floating), O2 = p2 || (w2 || !v2 ? [Z(c2)] : (function(t3) {
        const e3 = Z(t3);
        return [W(t3), e3, W(e3)];
      })(c2)), T2 = "none" !== m2;
      !p2 && T2 && O2.push(...X(c2, v2, m2, E2));
      const S2 = [c2, ...O2], A2 = yield a2.detectOverflow(e2, y2), L2 = [];
...
var Jt = (t2) => ({ name: "arrow", options: t2, fn(e2) {
  return __async(this, null, function* () {
    const { x: n2, y: o2, placement: i2, rects: r2, platform: l2, elements: c2, middlewareData: a2 } = e2, { element: u2, padding: h2 = 0 } = D(t2, e2) || {};
    if (null == u2) return {};
    const d2 = K(h2), f2 = { x: n2, y: o2 }, p2 = V(i2), g2 = H(p2), m2 = yield l2.getDimensions(u2), v2 = "y" === p2, y2 = v2 ? "top" : "left", x2 = v2 ? "bottom" : "right", b2 = v2 ? "clientHeight" : "clientWidth", w2 = r2.reference[g2] + r2.reference[p2] - f2[p2] - r2.floating[g2], E2 = f2[p2] - r2.reference[p2], O2 = yield null == l2.getOffsetParent ? void 0 : l2.getOffsetParent(u2);
    let T2 = O2 ? O2[b2] : 0;
    T2 && (yield null == l2.isElement ? void 0 : l2.isElement(O2)) || (T2 = c2.floating[b2] || r2.floating[g2]);
...
var te = (t2, e2, n2) => {
  ...
  return ((t3, e3, n3) => __async(null, null, function* () {
    const { placement: o3 = "bottom", strategy: i3 = "absolute", middleware: r3 = [], platform: l2 } = n3, c2 = r3.filter(Boolean), a2 = yield null == l2.isRTL ? void 0 : l2.isRTL(e3);
    let u2 = yield l2.getElementRects({ reference: t3, floating: e3, strategy: i3 }), { x: h2, y: d2 } = et(u2, o3, a2), f2 = o3, p2 = {}, g2 = 0;
    for (let n4 = 0; n4 < c2.length; n4++) {
      var m2;
      const { name: r4, fn: v2 } = c2[n4], { x: y2, y: x2, data: b2, reset: w2 } = yield v2({ x: h2, y: d2, initialPlacement: o3, placement: f2, strategy: i3, middlewareData: p2, rects: u2, platform: s({}, l2, { detectOverflow: null != (m2 = l2.detectOverflow) ? m2 : nt }), elements: { reference: t3, floating: e3 } });
      h2 = null != y2 ? y2 : h2, d2 = null != x2 ? x2 : d2, p2 = s({}, p2, { [r4]: s({}, p2[r4], b2) }), w2 && g2 <= 50 && (g2++, "object" == typeof w2 && (w2.placement && (f2 = w2.placement), w2.rects && (u2 = true === w2.rects ? yield l2.getElementRects({ reference: t3, floating: e3, strategy: i3 }) : w2.rects), { x: h2, y: d2 } = et(u2, f2, a2)), n4 = -1);
    }
  ...
  cancel() {
    return __async(this, null, function* () {
      if (this.options.confirmCancel) {
        ...
        let n2;
        n2 = e(this.options.confirmCancel) ? yield this.options.confirmCancel() : window.confirm(t2), n2 && this._done("cancel");
