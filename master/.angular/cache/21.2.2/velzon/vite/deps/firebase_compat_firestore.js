...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  L(e) {
    return __async(this, null, function* () {
      return this.db || (__PRIVATE_logDebug(k, "Opening database:", this.name), this.db = yield new Promise(((t, n) => {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  setDatabaseDeletedListener(e) {
    this.qi.q(((t) => __async(this, null, function* () {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.qi.runTransaction("shutdown", "readwrite", [Q, de], ((e) => {
  ...
  Uu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.Wu()) && this.qu("Reached the end of bundle when more is expected.");
      }
...
function __PRIVATE_firestoreClientListen(e, t, n, r) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    ...
    i.Nu(), e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
...
var Firestore2 = class {
  ...
  settings(settingsLiteral) {
    ...
    if (settingsLiteral.merge) {
      settingsLiteral = __spreadValues(__spreadValues({}, currentSettings), settingsLiteral);
  ...
  runTransaction(updateFunction) {
    return runTransaction(this._delegate, (transaction) => updateFunction(new Transaction3(this, transaction)));
  }
  batch() {
...
function configureForFirebase(firebase2, firestoreFactory) {
  ...
  }, "PUBLIC").setServiceProps(__spreadValues({}, firestoreNamespace)));
}
