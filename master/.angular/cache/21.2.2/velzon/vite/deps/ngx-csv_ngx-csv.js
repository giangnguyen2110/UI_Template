...
var require_ngx_csv = __commonJS({
  "node_modules/ngx-csv/ngx-csv.js"(exports) {
    ...
    var CsvConfigConsts = (function() {
      ...
      CsvConfigConsts2.DEFAULT_TITLE = "My Report";
      CsvConfigConsts2.DEFAULT_FILENAME = "mycsv.csv";
      CsvConfigConsts2.DEFAULT_SHOW_LABELS = false;
      CsvConfigConsts2.DEFAULT_USE_BOM = true;
      CsvConfigConsts2.DEFAULT_HEADER = [];
      CsvConfigConsts2.DEFAULT_NO_DOWNLOAD = false;
      CsvConfigConsts2.DEFAULT_REMOVE_EMPTY_VALUES = false;
    ...
    var ngxCsv = (function() {
      function ngxCsv2(DataJSON, filename, options) {
        this.csv = "";
        var config = options || {};
      ...
      ngxCsv2.prototype.generateCsv = function() {
      ...
      ngxCsv2.prototype.getHeaders = function() {
        var _this = this;
      ...
      ngxCsv2.prototype.getBody = function() {
      ...
      ngxCsv2.prototype.formartData = function(data) {
        if (this._options.removeEmptyValues && !data) {
          return "";
        }
        if (this._options.decimalseparator === "locale" && ngxCsv2.isFloat(data)) {
          return data.toLocaleString();
        }
        if (this._options.decimalseparator !== "." && ngxCsv2.isFloat(data)) {
      ...
      ngxCsv2.prototype.getCsv = function() {
        return this.csv;
      };
      ngxCsv2.isFloat = function(input) {
...
export default require_ngx_csv();
//# sourceMappingURL=ngx-csv_ngx-csv.js.map
