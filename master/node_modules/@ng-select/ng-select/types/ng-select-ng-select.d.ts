...
declare class NgSelectComponent implements OnChanges, OnInit, AfterViewInit, ControlValueAccessor {
    ...
    readonly clearKeepsDisabledOptions: _angular_core.InputSignalWithTransform<boolean, unknown>;
