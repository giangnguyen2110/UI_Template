...
var S = (n, i, e) => i in n ? T(n, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[i] = e;
...
import { Player as Q } from "@lordicon/web";
const I = {
  aliceblue: "#f0f8ff",
  antiquewhite: "#faebd7",
  aqua: "#00ffff",
...
const O = [
  ...
  createPlayer() {
    return y(this, null, function* () {
      ...
      }), this.destroySlot(), this._ready = !0, this.dispatchEvent(new CustomEvent("ready"));
    });
  }
  /**
...
const q = { attributes: !0, childList: !1, subtree: !1, attributeOldValue: !0 };
class F {
  constructor(i, e, t) {
    /**
     * Animation segments for mouse enter and leave actions.
...
const g = /^\d*(\.\d+)?$/, R = { attributes: !0, childList: !1, subtree: !1 };
class x {
  constructor(i, e, t) {
